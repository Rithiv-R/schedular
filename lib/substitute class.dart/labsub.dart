...
import 'package:schedular/substitute%20class.dart/sub2.dart';

class Labsub extends StatefulWidget {
  var user;
  var course;
  Labsub({this.user, this.course});

  @override
  _LabState createState() => _LabState();
}

class _LabState extends State<Labsub> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('LAB SUBSTITUTE CLASS'),
        actions: [
          IconButton(
              onPressed: () {
                  ...
                  children: <Widget>[
                    FlatButton(
                        onPressed: () {
                          if (slotlist.contains(id) || slotlist.contains(id1)) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (BuildContext context) => Sub2(
                        ...
                        child: Container(
                            ...
                            width: 300,
                            child: Center(
                                child: Text('FREE SLOTS FOR EXTRA CLASS',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                    ))))),
